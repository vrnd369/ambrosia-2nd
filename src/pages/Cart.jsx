...
export default function Cart() {
  ...
  function handleCheckout() {
    if (!isAuthenticated) {
      // Redirect to auth page, with return path so user comes back after login
      navigate('/auth', { state: { from: '/checkout' } });
      return;
    }
    // Proceed to real checkout form page
    navigate('/checkout');
  }
      ...
      {isEmpty ? (
        <div className="cart-empty">
          <div className="cart-empty-inner">
            ...
            <p className="cart-empty-text">Your cart feels a bit light.</p>
            <Link to="/buy" className="cart-browse-btn" id="cart-browse-products">
              BROWSE PRODUCTS
            </Link>
          </div>
        </div>
        ...
        <div className="cart-content">
          ...
          <div className="cart-summary">
            ...
            <button className="cart-clear-btn" onClick={clearCart} id="cart-clear">
              Clear Cart
            </button>
          </div>
        </div>
