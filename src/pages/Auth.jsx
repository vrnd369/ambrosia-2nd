              ...
              <div className={`auth-field ${fieldErrors.password ? 'auth-field--error' : ''}`}>
                ...
                <div className="auth-input-wrapper">
                  ...
                  <input
                    ...
                    className="auth-input"
                    placeholder={mode === 'login' ? 'Enter your password' : 'Min 8 chars, upper, lower, number, symbol'}
                    value={form.password}
                    onChange={handleChange}
                    onBlur={handleBlur}
            ...
            <p className="auth-mode-switch">
              {mode === 'login' ? (
                <>
                  ...
                  <button type="button" className="auth-mode-link" onClick={() => setMode('signup')} id="auth-switch-to-signup">
                    Sign up
                  </button>
                </>
              ) : (
                <>
                  ...
                  <button type="button" className="auth-mode-link" onClick={() => setMode('login')} id="auth-switch-to-login">
                    Log in
                  </button>
                </>
              )}
